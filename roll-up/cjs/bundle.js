...
(function (EButtonTypes) {
  ...
  EButtonTypes["TERTIARY"] = "tertiary";
})(EButtonTypes || (EButtonTypes = {}));
var EButtonSizes;
(function (EButtonSizes) {
  EButtonSizes["SMALL"] = "sm";
  EButtonSizes["MEDIUM"] = "md";
  EButtonSizes["LARGE"] = "lg";
})(EButtonSizes || (EButtonSizes = {}));
var EButtonIconPosition;
...
exports.EIConTypes = void 0;
(function (EIConTypes) {
  EIConTypes["ARROW_UP"] = "arrowUp";
  EIConTypes["ARROW_DOWN"] = "arrowDown";
  EIConTypes["ARROW_LEFT"] = "arrowLeft";
  EIConTypes["ARROW_RIGHT"] = "arrowRight";
})(exports.EIConTypes || (exports.EIConTypes = {}));
...
exports.EIconColors = void 0;
(function (EIconColors) {
  EIconColors["PRIMARY"] = "red";
  EIconColors["SECONDARY"] = "blue";
})(exports.EIconColors || (exports.EIconColors = {}));
...
const ForwardRef$3 = React__namespace.forwardRef(ArrowDownIcon);
var ArrowDownIcon$1 = ForwardRef$3;
...
const ForwardRef$2 = React__namespace.forwardRef(ArrowLeftIcon);
var ArrowLeftIcon$1 = ForwardRef$2;
...
const ForwardRef$1 = React__namespace.forwardRef(ArrowRightIcon);
var ArrowRightIcon$1 = ForwardRef$1;
...
const ForwardRef = React__namespace.forwardRef(ArrowUpIcon);
var ArrowUpIcon$1 = ForwardRef;
...
const Icon = ({
  ...
  const cssClasses = React$1.useMemo(() => {
    const decorations = [];
    if (size) {
  ...
  const iconMarkup = React$1.useMemo(() => {
    switch (type) {
      case exports.EIConTypes.ARROW_LEFT:
        return /*#__PURE__*/React$1.createElement(ArrowLeftIcon$1, null);
      case exports.EIConTypes.ARROW_RIGHT:
        return /*#__PURE__*/React$1.createElement(ArrowRightIcon$1, null);
      case exports.EIConTypes.ARROW_DOWN:
        return /*#__PURE__*/React$1.createElement(ArrowDownIcon$1, null);
      case exports.EIConTypes.ARROW_UP:
        return /*#__PURE__*/React$1.createElement(ArrowUpIcon$1, null);
    }
  }, [type]);
...
const Button = ({
  ...
  if (href) {
    return /*#__PURE__*/React.createElement("a", {
      ...
      href: href,
      target: "_blank"
    }, icon && iconPosition === EButtonIconPosition.LEFT && iconMarkup, /*#__PURE__*/React.createElement("span", {
      className: "c-button__text"
    }, label), icon && iconPosition === EButtonIconPosition.RIGHT && iconMarkup);
  } else {
